...
data_line <- data.frame(
  ...
  colour = unlist(lapply(1:pal_length, FUN = function(x) {rep(LETTERS[x], 8)}))
)
...
localities <- plotcolr:::sf_qld$LGA_CODE20
...
data_choropleth <- merge(plotcolr:::sf_qld, map_colours, by = "LGA_CODE20")
